...
<html lang="en">
    <head>
        ...
        <link href="<%=request.getContextPath()%>/adminResource/css/morris.css" rel="stylesheet">
    ...
    <body>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Revolutionizing Automotive AI</li>
                                </ul>
                                <h4>Revolutionizing Automotive AI</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
        ...
        <script src="<%=request.getContextPath()%>/adminResource/js/jquery.flot.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/jquery.flot.resize.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/jquery.flot.spline.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/jquery.sparkline.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/morris.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/raphael-2.1.0.min.js"></script>
        <script src="<%=request.getContextPath()%>/adminResource/js/bootstrap-wizard.min.js"></script>
