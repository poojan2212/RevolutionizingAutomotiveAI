                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Post Complaints</li>
                                </ul>
                                <h4>Post Complaints</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <f:form id="basicForm" action="insertComplaint.html" modelAttribute="complaintVO" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Post Complaints</h4>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="complaintSubject" class="form-control" placeholder="Type your subject..." required="required" />
                                                </div>
                                            </div><!-- form-group -->
                                          
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Complaint Description* <span class="asterisk"></span></label>
                                                <div class="col-sm-9">
                                                    <f:textarea path="complaintDescription" class="form-control" placeholder="Type your description..." required="required" />
                                                </div>
                                            </div><!-- form-group -->
                                          
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Complaint Attachment <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="file" name="complaintFile" class="form-control" required="required" />
                                                </div>
                                            </div><!-- form-group -->
