                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <f:form id="basicForm" action="insertBranch.html" method="post" modelAttribute="branchVO">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Add Branch</h4>
                                        
                                    </div><!-- panel-heading -->
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Branch Name <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="branchName" class="form-control" placeholder="Type branch name..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
                                          
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Branch Location <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:select path="locationVO.locationID" class="form-control">
                                          ...
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Branch Description<span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                	<f:textarea path="branchDescription" class="form-control" placeholder="Type branch description..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
