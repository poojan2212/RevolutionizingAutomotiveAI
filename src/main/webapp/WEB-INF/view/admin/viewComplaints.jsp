                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <ul class="breadcrumb">
                                    ...
                                    <li>User complaints Table</li>
                                </ul>
                                <h4>User complaints Table</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td><a href="<%=request.getContextPath()%>/document/complaints/${i.complaintFileName}" target="_blank" >view File</a></td>
										<td>${i.complaintStatus}</td>
										<td><a href="replytoUser.html?complaintId=${i.complaintId}" >Reply</a></td>
