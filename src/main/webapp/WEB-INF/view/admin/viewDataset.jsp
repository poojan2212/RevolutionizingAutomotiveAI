                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td>${i.datasetFileName}</td>
										<td><a href="<%=request.getContextPath()%>document/demo/${i.datasetFileName}" target="_blank" download>view File</a></td>
										<td><a href="deleteDataset.html?id=${i.datasetId}">delete</a></td>
										<td><a href="editDataset.html?id=${i.datasetId}">edit</a></td>
									</tr>
									</c:forEach>
