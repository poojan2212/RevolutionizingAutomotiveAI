                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <f:form id="basicForm" action="updateData.html" modelAttribute="VO" method="post">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Manage Dataset</h4>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                          ...
                                          <div class="form-group">
                                          		<label class="col-sm-3 control-label">Dataset Description <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="datasetDescription" class="form-control" placeholder="Type your description..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
                                           
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Add Dataset <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:input type="file" name="file" path="datasetFileName" class="form-control"  required="required" />
                                                </div>
                                            </div><!-- form-group -->
