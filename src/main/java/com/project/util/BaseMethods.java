	...
	// Send mail to user
		protected static void sendMail(String email, String subject , String content) {
			...
			try {
				...
				InternetAddress sender = new InternetAddress("noreply.revolutionizingai@gmail.com", "Revolutionizing Portal");
				...
				transport.connect("smtp.gmail.com", 587, "noreply.revolutionizingai@gmail.com" , "poojan2212");
