                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <f:form id="basicForm" action="insertReply.html" modelAttribute="complaintVO" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Reply Complaints</h4>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="complaintSubject" class="form-control" placeholder="Type your subject..."  readonly="true"/>
                                                </div>
                                            </div><!-- form-group -->
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:textarea path="complaintDescription" class="form-control" placeholder="Type your description..."  readonly="true"/>
                                                </div>
                                            </div><!-- form-group -->
                                          
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Complaint Reply <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:textarea path="reply" class="form-control" placeholder="Type your reply..." required="required" />
                                                </div>
                                            </div><!-- form-group -->
