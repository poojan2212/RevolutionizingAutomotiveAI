                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <f:form id="basicForm" action="updatePackage.html" modelAttribute="VO"  method="post">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:input type="text" name="name" path="packageDescription" class="form-control" placeholder="Type package description..." required="required" />
                                                </div>
                                            </div><!-- form-group -->
                                          
                                          <div class="form-group">
                                                <label class="col-sm-3 control-label">Number Of survey  <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
