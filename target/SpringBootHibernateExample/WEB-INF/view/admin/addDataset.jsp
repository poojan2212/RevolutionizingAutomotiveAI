                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <f:form id="basicForm" action="addData.html" modelAttribute="data" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Add Dataset</h4>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:textarea path="datasetDescription" class="form-control" placeholder="Type your description..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
