                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <f:form id="basicForm" action="updateLocation.html" method="post" modelAttribute="locationList" >
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Location Name <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="locationName" class="form-control" placeholder="Type location name..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                	<f:textarea path="locationDescription" class="form-control" placeholder="Type location description..." required="required"/>
                                                </div>
                                            </div><!-- form-group -->
